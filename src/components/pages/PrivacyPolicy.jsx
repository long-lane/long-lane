...
export const PrivacyPolicy = () => {
  useEffect(() => {
    rudderanalytics.page("Privacy Policy");
  }, []);
  ...
  return (
    <>
      <Helmet>
        <link
          rel="canonical"
          href="https://www.long-lane.co.uk/privacy-policy"
        />
        <title>Long Lane - Privacy Policy</title>
      </Helmet>
      <section className="privacy-policy" id="policy">
        <article>
          <h2>
            Privacy Policy
            <span>Last Updated On 25-Jul-2023</span>
            <span>Effective Date 25-Jul-2023</span>
          </h2>

          <p>
            This Privacy Policy describes the policies of Long Lane, United
            Kingdom of Great Britain and Northern Ireland (the), email:
            hello@long-lane.co.uk, on the collection, use and disclosure of your
            information that we collect when you use our website (
            https://long-lane.co.uk ). (the “Service”). By accessing or using
          ...
          <ol>
            ...
            <li>
              ...
              <p>
                ...
                2 years after user accounts remain idle or for as long as we
            ...
            <li>
              ...
              <p>
                ...
                to us at hello@long-lane.co.uk. We will respond to your request
            ...
            <li>
              ...
              <p>
                ...
                <a href="https://long-lane.co.uk/privacy-policy">
                  Cookie Policy.
                </a>
              </p>
            </li>
            ...
            <li>
              ...
              <p>
                ...
                Grievance Officer at Long Lane, hello@long-lane.co.uk, email:
                hello@long-lane.co.uk. We will address your concerns in
